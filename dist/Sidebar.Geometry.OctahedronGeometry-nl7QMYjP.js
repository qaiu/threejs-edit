...
function R(e, a) {
  ...
  s.add(new u(i.getKey("sidebar/geometry/octahedron_geometry/radius")).setClass("Label")), s.add(r), n.add(s);
  const o = new c(), d = new I(m.detail).setRange(0, 1 / 0).onChange(g);
  o.add(new u(i.getKey("sidebar/geometry/octahedron_geometry/detail")).setClass("Label")), o.add(d), n.add(o);
  function y() {
  ...
  function g() {
    e.execute(new h(e, a, new w.OctahedronGeometry(
      r.getValue(),
      d.getValue()
    )));
  }
...
//# sourceMappingURL=Sidebar.Geometry.OctahedronGeometry-nl7QMYjP.js.map
